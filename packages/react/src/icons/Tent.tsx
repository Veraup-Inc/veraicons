...
const bodies: Record<string, string> = {
  ...
  'stroke-sharp': "<path d=\"M12 3.5L21.5 20.5h-19z\" fill=\"none\" stroke=\"currentColor\" strokeWidth=\"1.5\" strokeLinecap=\"butt\" strokeLinejoin=\"miter\" stroke-miterlimit=\"2.0\" opacity=\"1.0\"/>\n  <path d=\"M12 3.5v17M8 20.5l4-8 4 8\" fill=\"none\" stroke=\"currentColor\" strokeWidth=\"1.5\" strokeLinecap=\"butt\" strokeLinejoin=\"miter\" stroke-miterlimit=\"2.0\" opacity=\"1.0\"/>",
  ...
  'solid-sharp': "<path d=\"M11.98 2L11.14 3.50L12.86 3.50L12.02 2ZM10.95 3.84L1.22 21.25L22.78 21.25L12.95 3.66L12.95 12.28L16.85 20.08L15.15 20.92L12.95 16.52L12.95 20.50L11.05 20.50L11.05 16.52L8.85 20.92L7.15 20.08L11.05 12.28L11.05 3.66Z\" fill=\"currentColor\" fillRule=\"evenodd\"/>",
